...
public class ShopActivity extends WackadooActivity implements ShopDataCallbackInterface, CreditsFragmentCallbackInterface,
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        ((TextView)findViewById(R.id.subheadingSpecial)).setTypeface(Typeface.createFromAsset(getAssets(), "fonts/obelix.ttf"));
        ((TextView)findViewById(R.id.shopSpecialOfferButton)).setTypeface(Typeface.createFromAsset(getAssets(), "fonts/obelix.ttf"));
        setUpUi();
        setUpButtons();
